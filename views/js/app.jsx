const AUTH0_CLIENT_ID = "yOWrdV43GolGa8ie7zE04gmMMtJ9QwIr"
const AUTH0_DOMAIN = "dev-r263jdgx.auth0.com"
const AUTH0_CALLBACK_URL = location.href
const AUTH0_API_AUDIENCE = "jokeish"
        ...
        this.auth0.parseHash((err, result) => {
            ...
            if (
                ...
                localStorage.setItem(
                    "profile",
                    JSON.stringify(result.idTokenPayload)
                )
